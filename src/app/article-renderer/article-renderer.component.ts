...
export class ArticleRendererComponent implements OnInit, AfterViewChecked {
  ...
  findAndCreateComponent(type: string, data: any) {
    ...
    //     }
    //   ]);
    //   const articleComponentRef = this.articleContent.createComponent(articleComponent, 0, injector);
    //
