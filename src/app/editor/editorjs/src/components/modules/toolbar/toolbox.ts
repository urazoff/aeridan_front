...
export default class Toolbox extends Module {
  ...
  private showTooltip(button: HTMLElement, toolName: string): void {
    ...
    const toolboxConfig = toolSettings[this.Editor.Tools.USER_SETTINGS.CONFIG] || {};
    const userToolboxSettings = toolSettings.toolbox || {};
    const name =  toolboxConfig.title || userToolboxSettings.title || toolboxSettings.title || toolName;
