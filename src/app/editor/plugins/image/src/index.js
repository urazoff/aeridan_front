 ...
 * @property {object} additionalRequestData - any data to send with _requests
...
export default class ImageTool {
  ...
  uploadingFailed(errorText) {
    ...
    this.api.notifier.show({
      message: this.config.errorMessage || 'Can not upload an image, try another',
      style: 'error'
    });
  ...
  validate(savedData) {
    return Boolean(Object.keys(savedData.file).length > 0 && savedData.file.url.trim());
  }
}
