...
class CodeTool {
  ...
  constructor({data, config, api}) {
    ...
    this.CSS = {
      ...
      preview: 'ce-code__preview',
      select: 'ce-code__select',
      autoOptionSpan: 'ce-code__auto-option-span',
      previewCodeType: 'ce-code__preview-code-type',
      previewContainer: 'ce-code__preview-container',
      pre: 'ce-code__pre'
    };
  ...
  drawView() {
    ...
    const wrapper = document.createElement('div'),
      ...
      previewCodeType = document.createElement('div'),
    ...
    selectLanguage.classList.add(this.CSS.select, this.CSS.input);
    previewCodeType.classList.add(this.CSS.previewCodeType);
    previewContainer.classList.add(this.CSS.previewContainer);
    pre.classList.add(this.CSS.pre);
    ...
    codeEditor.addEventListener('focusout', function (event) {
      if (event.explicitOriginalTarget.parentNode !== codeEditor && textarea.value) {
        ...
        previewCodeType.textContent = code.classList[1];
        selectLanguage.value = code.classList[1];
    ...
    const autoOptionSpan = document.createElement('span');
    autoOptionSpan.classList.add(this.CSS.autoOptionSpan);
    autoOption.value = "auto";
    autoOptionSpan.textContent = "Select Language (auto)";
    selectLanguage.appendChild(autoOption);
    autoOption.appendChild(autoOptionSpan);
    ...
    selectLanguage.value = this.data.language;

    wrapper.appendChild(codeEditor);
    codeEditor.appendChild(selectLanguage);
    codeEditor.appendChild(textarea);
    wrapper.appendChild(previewContainer);
    previewContainer.appendChild(previewCodeType);
    previewContainer.appendChild(preview);
    preview.appendChild(pre);
    pre.appendChild(code);
    this.nodes.selectLanguage = selectLanguage;
  ...
  set data(data) {
    ...
    if (this.nodes.selectLanguage) {
      this.nodes.selectLanguage.value = data.language;
    }
  }
